            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white p-6 md:p-8 rounded-xl shadow-md border border-gray-100">
                <div className="prose prose-lg max-w-none">
                  <p>
                    Welcome to Internexis ("we," "our," or "us"). These Terms of
                    ...
                    and the virtual internship services we provide. By accessing
                  ...
                  <ul className="list-disc pl-6 mb-6">
                    ...
                    <li>
                      Be a student, graduate, or professional interested in
                      skill development or career training.
                    </li>
                    <li>Provide accurate information during registration.</li>
                  </ul>
                  <p>
                    We reserve the right to verify your identity and academic
                    status before or during the internship.
                  </p>
                  ...
                  <p>
                    Internexis offers virtual internship programs in the
                    following domains:
                  </p>
                  ...
                  <ul className="list-disc pl-6 mb-6">
                    ...
                    <li>
                      Possible rewards or full-time job recommendations for top
                      performers
                    </li>
                  </ul>
                  ...
                  <p>
                    To access internship programs, users must create an account.
                    You agree to:
                  </p>
                  <ul className="list-disc pl-6 mb-6">
                    <li>Provide true, current, and complete information.</li>
                    <li>
                      Maintain the confidentiality of your account login
                      credentials.
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    information provided is inaccurate or violates our code of
                    conduct.
                  </p>
                  ...
                  <p>
                    All internship programs are prepaid and priced as follows:
                  </p>
                  <ul className="list-disc pl-6 mb-4">
                    <li>1 Month – ₹199</li>
                    <li>2 Months – ₹299</li>
                  ...
                  <p>
                    All fees are <strong>non-refundable</strong>, except in
                    cases where Internexis cancels the internship or fails to
                    deliver the service.
                  </p>

                  <h3 className="text-xl font-bold mt-8 mb-4 text-gray-900">
                    5. Internship Code of Conduct
                  </h3>
                  ...
                  <ul className="list-disc pl-6 mb-6">
                    ...
                    <li>
                      Maintain academic honesty — no plagiarism or copied
                      submissions.
                    </li>
                  ...
                  <p>
                    Violation of this code may result in termination of your
                    access and forfeiture of certificates without refund.
                  </p>
                  ...
                  <p>
                    Certificates include a unique verification ID and can be
                    verified through our portal.
                  </p>
                  ...
                  <p>
                    All content on the Internexis platform — including courses,
                    images, logos, designs, code samples, and illustrations — is
                    the property of Internexis or its partners and is protected
                    under copyright law. Unauthorized reproduction or
                  ...
                  <ul className="list-disc pl-6 mb-6">
                    ...
                    <li>
                      Submit Internexis projects as your original work elsewhere
                      without disclosure.
                    </li>
                  </ul>
                  ...
                  <p>
                    Your data privacy is important to us. We collect personal
                    information only to facilitate your internship experience.
                  ...
                  <p>
                    We do not guarantee job placement. Our platform is meant for
                    learning and skill-building, not guaranteed employment.
                  </p>
                  ...
                  <ul className="list-disc pl-6 mb-6">
                    ...
                    <li>
                      Update these Terms at any time. Changes will be posted on
                      this page.
                    </li>
                  </ul>
                  <p>
                    By continuing to use the service after changes, you agree to
                    the updated terms.
                  </p>
                  ...
                  <p>
                    For any questions or legal concerns related to these Terms
                    of Service:
                  </p>
                  <ul className="list-none pl-0 mb-6">
                    ...
                    <li className="flex items-center mb-2">
                      <span className="mr-2">🌐</span> <strong>Website:</strong>{" "}
                      <a
                        href="https://www.internexis-technologies.in"
                        className="text-blue-600 hover:underline ml-1"
                      >
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="ml-1">Virtual HQ – India</span>
                    </li>
                  </ul>

                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 mt-8">
                    <p className="text-sm text-blue-800 mb-0">
                      <strong>Last Updated:</strong> These Terms of Service were
                      last updated on{" "}
