  ...
  const benefits = [
    {
      ...
      description:
        "Earn ₹1,500 for just 10 students (₹1000 course × 15%). Turn your campus connections into consistent income stream.",
    ...
    },
    {
      ...
      description:
        "Build exceptional experience as Campus Ambassador + Marketer + Influencer. Stand out in job applications.",
    ...
    },
    {
      ...
      description:
        "Connect with tech leaders, HRs, fellow ambassadors. Get LinkedIn shoutouts and industry exposure.",
    ...
    },
    {
      ...
      description:
        "Receive internship certificates, attend exclusive events, and gain access to premium resources.",
    ...
    },
    {
      ...
      description:
        "Top performers receive amazing gifts, branded merchandise, and Letter of Recommendations.",
    ...
    },
    {
      ...
      description:
        "No caps on referrals, no complex milestones. Your earnings grow directly with your efforts.",
      highlight: "No Limits",
  ...
  const howItWorks = [
    {
      ...
      title: "Get Your Link",
      description:
        "Get your personal referral link after joining as Campus Ambassador.",
      color: "from-blue-500 to-indigo-500",
    },
    {
      step: "2",
      ...
      title: "Share & Promote",
      description:
        "Share it with friends, classmates, college groups, clubs & social media.",
    ...
    },
    {
      ...
      description:
        "Earn 15% of each successful paid registration made through your link.",
      color: "from-purple-500 to-pink-500",
    },
    {
      step: "4",
      ...
      description:
        "Receive earnings monthly via UPI or bank transfer – hassle-free.",
      color: "from-orange-500 to-red-500",
    },
  ];
  ...
  return (
    <div id="benefits" className="py-20 relative overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-[10%] left-[5%] w-80 h-80 bg-gradient-to-r from-pink-500/10 to-red-500/10 rounded-full mix-blend-multiply filter blur-3xl animate-blob"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-[50%] left-[50%] w-72 h-72 bg-gradient-to-r from-cyan-500/10 to-teal-500/10 rounded-full mix-blend-multiply filter blur-3xl animate-blob"
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black mb-8 leading-tight">
            <span className="block text-gray-900 hover:text-blue-600 transition-colors duration-500">
              📢 Share Opportunities.
            </span>
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <p className="text-xl md:text-2xl text-transparent bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text font-bold">
              💥 Then it's time to monetize your influence and become a
              Changemaker on your campus!
            </p>
          </div>
        </div>{" "}
        ...
        >
          <div className="relative hover-lift">
            ...
            <div className="relative bg-gradient-to-br from-emerald-500 to-teal-500 rounded-3xl p-10 text-white shadow-2xl overflow-hidden animate-borderGlow">
              ...
              <div
                className="absolute bottom-0 left-0 w-48 h-48 bg-white/10 rounded-full translate-y-24 -translate-x-24 animate-float"
                style={{ animationDelay: "2s" }}
              ></div>
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                  <div
                    className="glass-effect rounded-2xl p-6 border border-white/20 hover-lift animate-slideUp"
                    style={{ animationDelay: "0.8s" }}
                  >
                    <div className="text-2xl font-bold mb-2 animate-heartbeat">
                      ✅ No Milestones Needed
                    </div>
                    <p className="text-lg text-emerald-100">
                      Start earning from your first referral
                    </p>
                  </div>
                  <div
                    className="glass-effect rounded-2xl p-6 border border-white/20 hover-lift animate-slideUp"
                  ...
                  >
                    <div
                      className="text-2xl font-bold mb-2 animate-heartbeat"
                      style={{ animationDelay: "0.5s" }}
                    >
                      ✅ No Limits on Referrals
                    </div>
                    <p className="text-lg text-emerald-100">
                      Invite unlimited friends and earn more
                    </p>
                  </div>
                  <div
                    className="glass-effect rounded-2xl p-6 border border-white/20 hover-lift animate-slideUp"
                  ...
                  >
                    <div
                      ...
                      style={{ animationDelay: "1s" }}
                    >
                      ✅ Earnings Grow With You
                    </div>
                    <p className="text-lg text-emerald-100">
                      Your income scales with your network
                    </p>
                  </div>
                </div>
              </div>
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto animate-float">
              See how much you can earn with our simple 15% flat commission
              structure ✨
            </p>
          </div>
                  ...
                  {earningExamples.map((example, index) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-6 whitespace-nowrap text-lg font-bold text-green-600 group-hover:text-green-700 transition-colors">
                        ...
                        <span
                          className="ml-2 opacity-0 group-hover:opacity-100 transition-opacity text-sm animate-bounce"
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${benefit.color} opacity-0 group-hover:opacity-15 transition-opacity duration-500`}
                />

                <div className="relative z-10">
                  <div className="mb-4">
                    <div
                      className={`inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br ${benefit.color} rounded-xl text-white text-xl shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
                  ...
                  <div
                    className={`inline-flex items-center px-3 py-1 bg-gradient-to-r ${benefit.color} rounded-full shadow-md group-hover:scale-105 transition-transform duration-300`}
                  >
            ...
            {howItWorks.map((step, index) => (
              <div key={index} className="relative">
                <div className="glass-effect rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border hover-lift group">
                  <div
                    className={`inline-flex items-center justify-center w-10 h-10 bg-gradient-to-br ${step.color} rounded-lg text-white text-sm font-bold mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
                    <span>{step.step}</span>
                  </div>
              ...
              <div
                ...
                className={`group relative bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-500 border-2 overflow-hidden hover-lift ${
                  tier.featured
                    ...
                    : "border-gray-200/50 hover:border-white"
                }`}
              >
                {tier.featured && (
                ...
                <div className="relative z-10 text-center">
                  <div
                    className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br ${tier.color} rounded-2xl text-white text-3xl shadow-lg mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                    {tier.icon}
                  </div>
                  ...
                  <div
                    className={`text-3xl font-black bg-gradient-to-r ${tier.color} bg-clip-text text-transparent mb-4`}
                  >
                    {tier.cashReward}
                  </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {bonusRewards.map((bonus, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${bonus.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
                />
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div
                    className={`text-2xl font-black bg-gradient-to-r ${bonus.color} bg-clip-text text-transparent mb-3`}
                  >
                    {bonus.reward}
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <span className="text-base">
                    Only paid, genuine signups through your unique link are
                    counted.
                  </span>
                </div>
                <div className="flex items-start">
                  <span className="text-yellow-600 mr-3 mt-1 text-lg">•</span>
                  <span className="text-base">
                    No referral caps – invite as many as you want!
                  </span>
                </div>
                <div className="flex items-start">
                  <span className="text-yellow-600 mr-3 mt-1 text-lg">•</span>
                  <span className="text-base">
                    No fake/spam entries – quality over quantity.
                  </span>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-start">
                  <span className="text-yellow-600 mr-3 mt-1 text-lg">•</span>
                  <span className="text-base">
                    Payouts are sent monthly after verification.
                  </span>
                </div>
                <div className="flex items-start">
                  <span className="text-yellow-600 mr-3 mt-1 text-lg">•</span>
                  <span className="text-base">
                    Internexis reserves the right to review accounts for
                    fairness.
                  </span>
                </div>
              </div>{" "}
