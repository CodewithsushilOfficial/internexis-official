...
if (
  ...
  !document.querySelector("#image-slider-styles")
) {
...
const ImageSlider: React.FC = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      imageAlt:
        "Professional young person in business attire representing growth",
    },
    {
    ...
    <div className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 text-center mb-16">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          Discover how our ambassadors are making a difference in their
