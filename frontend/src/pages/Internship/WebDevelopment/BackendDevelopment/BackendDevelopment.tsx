...
import { Server, Database, Shield, Calendar, Users, Award } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Master Node.js, Express, and backend frameworks for robust applications"
    },
    {
      icon: <Database className="w-6 h-6" />,
      title: "Database Management",
      description: "Work with MongoDB, PostgreSQL, and database optimization techniques"
    },
    {
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
              Backend Development <span className="text-green-600">Internship</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              Build scalable server-side applications and robust APIs
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Comprehensive backend development skills for enterprise applications
            </p>
          </motion.div>
