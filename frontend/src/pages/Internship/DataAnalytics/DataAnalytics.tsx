...
import { BarChart3, LineChart, Database, Calendar, Users, Award } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Master statistical methods and data interpretation"
    },
    {
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
              Data Analytics <span className="text-indigo-600">Internship</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              Analyze data patterns and create meaningful business insights
            </p>
