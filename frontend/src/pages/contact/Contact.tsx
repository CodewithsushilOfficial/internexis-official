...
export const Contact: React.FC = () => {
  ...
  return (
    <section
      className="py-16 md:py-24 bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-indigo-950 dark:via-gray-900 dark:to-purple-950 relative overflow-hidden"
      id="contact"
    >
      {/* Background elements */}{" "}
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <motion.div variants={itemVariants} className="relative">
                ...
                <label
                  htmlFor="name"
                  className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 bg-clip-text text-transparent"
                >
                  Full Name
                </label>
              ...
              <motion.button
                ...
                className={`w-full font-medium py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 ${
                  isSubmitting
              ...
              <input
                type="hidden"
                name="access_key"
                value="3964ead3-fbb7-43bb-89f0-c3a8980b0cf4"
              />
              <input
                type="hidden"
                name="redirect"
              ...
              <input
                type="hidden"
                name="to_email"
                value="help.internexis@gmail.com"
              />
            </form>
          </motion.div>
          ...
          <div className="space-y-8" data-aos="fade-left">
            ...
            >
              {" "}
              <h3 className="text-xl font-semibold mb-3 bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 bg-clip-text text-transparent">
                Working Hours
              </h3>
