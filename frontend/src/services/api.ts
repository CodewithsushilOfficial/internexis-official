...
export const digitalSolutionsAPI = {
  ...
  create: (data: CreateDigitalSolutionData) =>
    api.post("/api/digital-solutions/admin", data),
  update: (id: string, data: UpdateDigitalSolutionData) =>
    api.put(`/api/digital-solutions/admin/${id}`, data),
...
export const internshipOpportunitiesAPI = {
  ...
  create: (data: CreateInternshipOpportunityData) =>
    api.post("/api/internships/admin/opportunities", data),
  update: (id: string, data: UpdateInternshipOpportunityData) =>
    api.put(`/api/internships/admin/opportunities/${id}`, data),
  delete: (id: string) =>
    api.delete(`/api/internships/admin/opportunities/${id}`),
  incrementApplications: (id: string) =>
    api.patch(`/api/internships/opportunities/${id}/apply`),
...
export const jobOpportunitiesAPI = {
  ...
  create: (data: CreateJobOpportunityData) =>
    api.post("/api/jobs/admin/jobs", data),
  update: (id: string, data: UpdateJobOpportunityData) =>
    api.put(`/api/jobs/admin/jobs/${id}`, data),
  delete: (id: string) => api.delete(`/api/jobs/admin/jobs/${id}`),
  incrementApplications: (id: string) =>
    api.patch(`/api/jobs/jobs/${id}/apply`),
...
export const hackathonEventsAPI = {
  ...
  create: (data: CreateHackathonEventData) =>
    api.post("/api/hackathons/admin", data),
  update: (id: string, data: UpdateHackathonEventData) =>
    api.put(`/api/hackathons/admin/${id}`, data),
  delete: (id: string) => api.delete(`/api/hackathons/admin/${id}`),
  updateStatus: (id: string, status: string) =>
    api.patch(`/api/hackathons/admin/${id}/status`, { status }),
};
...
export const workWithUsAPI = {
  ...
  create: (data: CreateWorkWithUsData) =>
    api.post("/api/work-with-us/admin", data),
  update: (id: string, data: UpdateWorkWithUsData) =>
    api.put(`/api/work-with-us/admin/${id}`, data),
  delete: (id: string) => api.delete(`/api/work-with-us/admin/${id}`),
  incrementApplications: (id: string) =>
    api.patch(`/api/work-with-us/${id}/apply`),
...
export const mentorshipAPI = {
  ...
  getByExpertise: (expertise: string) =>
    api.get(`/api/mentorship/expertise/${expertise}`),
  getById: (id: string) => api.get(`/api/mentorship/${id}`),
  create: (data: CreateMentorshipData) =>
    api.post("/api/mentorship/admin", data),
  update: (id: string, data: UpdateMentorshipData) =>
    api.put(`/api/mentorship/admin/${id}`, data),
