    ...
    const animateFloating = () => {
      Array.from(icons).forEach((icon, index) => {
        ...
        setTimeout(() => {
          ...
          element.style.transition = 'transform 3s cubic-bezier(0.4, 0, 0.2, 1)';
        }, delay);
      });
    };
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-white dark:bg-gray-900 overflow-hidden opacity-60 dark:opacity-50">
        ...
        <div className="absolute top-20 right-[20%] w-64 h-64 border border-primary-200/15 dark:border-primary-700/10 rounded-full z-0 animate-pulse" style={{ animationDuration: '15s' }}></div>
        <div className="absolute bottom-40 left-[15%] w-48 h-48 border border-secondary-200/15 dark:border-secondary-700/10 rounded-full z-0 animate-pulse" style={{ animationDuration: '18s' }}></div>
        <div className="absolute top-1/3 left-[60%] w-32 h-32 border border-accent-200/15 dark:border-accent-700/10 rounded-full z-0 animate-pulse" style={{ animationDuration: '12s' }}></div>
        
        {/* Modern abstract shapes with reduced opacity to complement 3D scene */}
        <div className="absolute top-[15%] left-[10%] w-40 h-40">
          <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-5 dark:opacity-8">
            <path d="M50 0L93.3 75H6.7L50 0Z" fill="currentColor" className="text-primary-500 dark:text-primary-400" />
          </svg>
        </div>
        <div className="absolute bottom-[20%] right-[15%] w-28 h-28">
          <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-5 dark:opacity-8">
            <rect x="10" y="10" width="80" height="80" rx="20" fill="currentColor" className="text-secondary-500 dark:text-secondary-400" />
          </svg>
        </div>
        
        {/* Additional floating elements that complement the 3D scene */}
        <div className="absolute top-[40%] right-[25%] w-16 h-16">
          <svg width="100%" height="100%" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-5 dark:opacity-8 animate-pulse" style={{ animationDuration: '20s' }}>
            <circle cx="50" cy="50" r="40" fill="currentColor" className="text-accent-500 dark:text-accent-400" />
          </svg>
        </div>
            ...
            <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="dots-1" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                  <circle cx="4" cy="4" r="1.5" fill="currentColor" className="text-primary-500 dark:text-primary-400" />
                </pattern>
              </defs>
            ...
            <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="dots-2" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                  <circle cx="4" cy="4" r="1" fill="currentColor" className="text-secondary-500 dark:text-secondary-400" />
                </pattern>
              </defs>
      ...
      >
        <div className="absolute top-1/4 left-1/4 transition-transform backdrop-blur-sm p-3 rounded-xl bg-white/10 dark:bg-gray-800/10">
          <Code size={48} className="text-blue-600 dark:text-blue-400 drop-shadow" />
        </div>
        <div className="absolute top-1/5 right-1/4 transition-transform backdrop-blur-sm p-3 rounded-xl bg-white/10 dark:bg-gray-800/10">
          <Monitor size={42} className="text-purple-600 dark:text-purple-400 drop-shadow" />
        </div>
        <div className="absolute bottom-1/3 left-1/3 transition-transform backdrop-blur-sm p-3 rounded-xl bg-white/10 dark:bg-gray-800/10">
          <Bot size={38} className="text-green-600 dark:text-green-400 drop-shadow" />
        </div>
        <div className="absolute bottom-1/4 right-1/3 transition-transform backdrop-blur-sm p-3 rounded-xl bg-white/10 dark:bg-gray-800/10">
          <MoveRight size={36} className="text-accent-500 dark:text-accent-400 drop-shadow" />
        </div>
        <div className="absolute top-2/5 left-2/3 transition-transform backdrop-blur-sm p-3 rounded-xl bg-white/10 dark:bg-gray-800/10">
          <Sparkles size={32} className="text-secondary-500 dark:text-secondary-400 drop-shadow" />
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-20">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mt-8 md:mt-0">
          ...
          <div className="w-full lg:w-5/12 space-y-7">
            ...
            >
              Start your tech journey with practical, affordable internships 
              and training programs that build your portfolio with real projects 
            ...
            >
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border- dark:border-gray-800 overflow-hidden ring-2 ring-primary-50 dark:ring-primary-900 shadow-sm">
                    <img 
              ...
              <div className="text-sm font-medium text-gray-600 dark:text-gray-400">
                <span className="font-bold text-lg text-gray-900 dark:text-white">15,000+</span> students trained
              </div>
            </motion.div>
          </div>
            ...
            <div className="relative">
              ...
              >
                <div className="text-center">
                  <div className="text-xl font-bold text-accent-500 mb-0.5">₹99</div>
                  <div className="text-[10px] text-gray-600 dark:text-gray-300 font-medium">Internship starts at</div>
                  <div className="mt-1 text-[9px] font-medium text-primary-500 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/30 py-0.5 px-1.5 rounded-full mx-auto inline-block">100% placement assistance</div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs font-medium text-primary-600 dark:text-primary-400">Industry recognized</div>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 120" className="w-full h-auto fill-white dark:fill-gray-900 transform translate-y-1" preserveAspectRatio="none">
