...
export const Testimonials: React.FC = () => {
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote:
        "Internexis gave me real-world experience and helped me land my first client! The project-based approach taught me more than classroom lectures ever did.",
      image:
    ...
    },
    {
      ...
      quote:
        "The ₹199 internship was more valuable than my college semester! I built a functional app that now sits proudly on my portfolio and helped me secure interviews.",
      image:
    ...
    },
    {
      ...
      quote:
        "The mentorship was incredible. My supervisor guided me through implementing a real ML model that solved an actual business problem. Totally worth it!",
      image:
    ...
    },
    {
      ...
      quote:
        "The data science program helped me transition from a complete beginner to someone who can confidently work with real datasets and derive meaningful insights.",
      image:
    ...
    },
    {
      ...
      quote:
        "As a design student, I appreciated how the internship connected design theory with practical implementation. My portfolio now showcases real products I designed.",
      image:
  ...
  return (
    <section
      className="py-20 relative overflow-hidden bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-800"
      id="testimonials"
    >
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p
            ...
            data-aos-delay="200"
          >
            Real feedback from students who transformed their careers through
            our internships
          </p>
        </div>
