      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-x-8 gap-y-16 mb-16">
          ...
          <div className="lg:col-span-4" data-aos="fade-up">
            ...
            <p className="text-gray-300 mb-8 leading-relaxed text-base">
              ...
              empower students to gain practical experience, build portfolios,
            ...
            <ul className="space-y-4">
              ...
              {[
                ...
                >
                  ...
                  >
                    <span className="inline-block w-0 group-hover:w-4 overflow-hidden transition-all duration-300 ease-out opacity-0 group-hover:opacity-100">
                      &raquo;
                    </span>
              ...
              <div className="relative group">
                <AnimatePresence>
                  {!emailSubmitted ? (
                    ...
                    >
                      <CheckCircle size={18} className="mr-2" /> Thank you for
                      subscribing!
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              <div className="flex gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    hoverClass:
                      "hover:bg-gradient-to-r hover:from-[#F58529] hover:to-[#DD2A7B]",
                  },
                ].map((platform, index) => (
                  <motion.a
                    key={index}
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 text-sm">
          <div className="flex items-center text-gray-400">
            ...
            >
              © {new Date().getFullYear()} Internexis Technologies. All rights
              reserved. Made with{" "}
              <Heart
                className="inline-block h-4 w-4 text-accent-500 hover:text-red-500 transition-colors"
                fill="#ff6b6b"
              />{" "}
              in India
            </motion.p>
