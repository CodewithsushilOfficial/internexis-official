...
export const WhyChoose: React.FC = () => {
  ...
  const reasons: Reason[] = [
    {
      ...
      description:
        "Our internship certificates are approved by the All India Council for Technical Education (AICTE), giving your resume an authentic credibility boost.",
      icon: <Award size={28} />,
      color: "blue",
    },
    {
      ...
      description:
        "Work on actual industry-relevant projects that solve real problems, not just textbook exercises. Build a portfolio that showcases your practical skills.",
      icon: <Code size={28} />,
      color: "green",
    },
    {
      ...
      description:
        "Get guidance from experienced professionals who review your code, provide feedback, and help you overcome challenges in your learning journey.",
    ...
    },
    {
      ...
      description:
        "Learn to work in distributed teams using professional collaboration tools like GitHub, preparing you for real workplace environments.",
      icon: <Users size={28} />,
      color: "pink",
    },
    {
      ...
      description:
        "Complete your internship on your own schedule from anywhere in the world, with programs starting at just ₹199 - accessible to all students.",
      icon: <Clock size={28} />,
      color: "yellow",
    },
    {
      ...
      description:
        "Gain practical experience that bridges the gap between academic learning and industry requirements, making you immediately valuable to employers.",
    ...
    },
    {
      ...
      description:
        "Add verified project experience to your resume and build an impressive portfolio that demonstrates your capabilities to potential employers.",
    ...
    },
    {
      ...
      description:
        "Excel in your internship to earn additional rewards, recognition, and potential job referrals to our network of hiring partners.",
      icon: <Gift size={28} />,
      color: "orange",
    },
  ];
  ...
  return (
    <section
      className="py-24 bg-gradient-to-b from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-900/90 dark:to-gray-800/95 relative overflow-hidden"
      id="why-choose"
    >
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div
          className="max-w-3xl mx-auto text-center mb-24 relative"
          data-aos="fade-up"
        >
          <motion.div
          ...
          >
            We're transforming how students gain practical experience and
          ...
          {reasons.map((reason, index) => (
            <motion.div
              ...
              whileHover={{
                ...
                scale: 1.03,
                boxShadow:
                  "0 30px 35px -12px rgba(0, 0, 0, 0.18), 0 15px 20px -5px rgba(0, 0, 0, 0.06)",
                transition: { duration: 0.5, ease: [0.33, 1, 0.68, 1] },
              }}
              whileTap={{
                scale: 0.97,
                boxShadow:
                  "0 15px 20px -10px rgba(0, 0, 0, 0.1), 0 5px 10px -5px rgba(0, 0, 0, 0.04)",
                y: -8,
            ...
            >
              ...
              <motion.div
                ...
                animate={{
                  opacity: activeReason === index ? 0.8 : 0,
                  scale: 1,
                }}
                ...
                <div className="mt-auto pt-4">
                  ...
                  >
                    ...
                    >
                      <ArrowRight
                        size={16}
                        className={`${activeReason !== index ? "drop-shadow-sm" : ""}`}
                      />
                    </motion.div>
                  </motion.button>
                </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              >
                ...
                >
                  ...
                  of our interns report that their Internexis experience helped
                  them secure their first job or freelance client. Our
                  industry-aligned projects give you a significant competitive
