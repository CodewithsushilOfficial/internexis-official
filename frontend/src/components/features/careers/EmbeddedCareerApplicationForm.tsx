...
const EmbeddedCareerApplicationForm: React.FC = () => {
  ...
  const skillOptions = [
    ...
    'MongoDB', 'PostgreSQL', 'Express.js', 'Next.js', 'Vue.js', 'Angular',
  ...
  const isStepValid = (step: number) => {
    switch (step) {
      ...
      case 2:
        return formData.roleType && formData.skills.length > 0 && formData.experience;
      case 3:
        return formData.availability && formData.whyJoin;
      case 4:
        return true;
      default:
        return false;
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Thank you for applying to join our team! We'll review your application and get back to you within 2-3 business days. You'll receive a confirmation email shortly.
          </motion.p>
          ...
          >
            We're excited to learn more about you and explore how you can contribute to our team!
          </motion.p>
        </motion.div>
      </motion.div>
    );
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <motion.div 
        className="bg-white/90 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg border border-white/50"
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 p-6 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center mb-4">
              ...
              <p className="mt-2 text-white/90">Start your career journey with Internexis</p>
            </div>
...
export default EmbeddedCareerApplicationForm;
