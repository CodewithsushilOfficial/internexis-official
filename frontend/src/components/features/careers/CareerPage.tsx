...
const CareerPage: React.FC = () => {
  ...
  const storsetImages = {
    heroAnimation:
      "https://storyset.com/illustration/programming/amico/animate.svg",
    studentDeveloper:
      "https://storyset.com/illustration/education/cuate/animate.svg",
    ...
    volunteer:
      "https://storyset.com/illustration/helping-hand/cuate/animate.svg",
    teamwork: "https://storyset.com/illustration/team-work/rafiki/animate.svg",
    innovation:
      "https://storyset.com/illustration/innovation/amico/animate.svg",
    growth:
      "https://storyset.com/illustration/growth-analytics/pana/animate.svg",
    ...
    service:
      "https://storyset.com/illustration/customer-service/cuate/animate.svg",
    support:
      "https://storyset.com/illustration/technical-support/rafiki/animate.svg",
    collaboration:
      "https://storyset.com/illustration/collaboration/amico/animate.svg",
    learning: "https://storyset.com/illustration/learning/bro/animate.svg",
    career:
      "https://storyset.com/illustration/career-progress/pana/animate.svg",
  };
  // High-Quality Premium Images - Carefully Selected for Each Section
  const premiumImages = {
    // Hero Section - Professional Programming & Coding
    heroMain:
      "https://images.unsplash.com/photo-1576267423445-b2e0074d68a4?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    heroCoding:
    ...
    remoteFreelancer:
      "https://images.unsplash.com/photo-1583508915901-b5f84c1dcde1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    campusAmbassador:
    ...
    aiMachineLearning:
      "https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2032&q=80",
    dataScience:
    ...
    innovationLab:
      "https://images.unsplash.com/photo-1581093458791-9f3c3250e670?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    flexibleWork:
      "https://images.unsplash.com/photo-1600298881974-6be191ceeda1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2128&q=80",
    modernOffice:
    ...
    const getAnimationElements = () => {
      switch (type) {
        ...
        default:
          return (
            <div
              className={`w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl ${className}`}
            />
          );
      }
    };
  ...
  const opportunities = [
    {
      ...
      description:
        "Join our core team and work on cutting-edge projects while studying",
      icon: GraduationCap,
    ...
    },
    {
      ...
      description:
        "Guide the next generation of talent and share your expertise",
      icon: Award,
    ...
    },
    {
      ...
      description:
        "Represent Internexis at your university and build communities",
      icon: MapPin,
  ...
  const companyValues = [
    {
      ...
      description:
        "We embrace cutting-edge technologies and creative solutions to solve real-world problems.",
    ...
    },
    {
      ...
      title: "Team Spirit",
      description:
        "Collaboration and mutual support drive our success. We grow together as one team.",
    ...
    },
    {
      ...
      title: "Excellence",
      description:
        "We set high standards and strive for perfection in everything we deliver.",
      color: "from-orange-500 to-red-500",
    ...
    },
    {
      ...
      title: "Global Impact",
      description:
        "Our work spans across continents, creating positive change worldwide.",
      color: "from-purple-500 to-pink-500",
  ...
  ]; // Using a static image instead of rotation
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center mb-28">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-gray-600 leading-relaxed">
                  ...
                  Whether you're a student starting your journey or a
                  professional ready for new challenges, we have the perfect
                  opportunity for you.
                </p>
              ...
              <motion.div
                ...
                className="relative w-full lg:w-[520px] xl:w-[560px] mx-auto"
              >
                {" "}
                <div
                  className="relative p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                  style={{ transform: "perspective(1000px) rotateY(-3deg)" }}
                >
                  {" "}
                  <div className="relative z-10">
                    {" "}
                    {/* High-Quality Professional Coding Hero Image - Card Style */}{" "}
                    <div className="w-full aspect-[4/3] rounded-lg bg-white flex items-center justify-center shadow-md overflow-hidden relative transition-all duration-500 border-0">
                      {" "}
                      ...
                      <img
                        ...
                        loading="eager"
                      />{" "}
                      {/* Removing card title overlay and gradient overlay */}
                  ...
                  {/* Floating Elements Around Hero Animation - Static */}{" "}
                  {/* Static decorative elements - smaller size */}
              ...
              {heroStats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-white/50 hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="text-4xl font-black text-gray-900 mb-2 text-center">
                      {stat.number}
                    </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {companyValues.map((value, index) => (
                ...
                >
                  <div
                    className={`relative ${value.bgPattern} rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-white/50 overflow-hidden`}
                  >
                    {/* Background Pattern */}
                    ...
                    <div className="relative z-10">
                      <div
                        className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r ${value.color} rounded-2xl mb-6 group-hover:scale-110 transition-all duration-300 shadow-xl`}
                      >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Discover the perfect role that matches your skills, interests,
                and career goals. Each opportunity is designed to help you grow
              ...
              {opportunities.map((opportunity, index) => (
                ...
                >
                  ...
                  <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-white/50">
                    {" "}
                    {/* High-Quality Premium Image Section */}
                    <div className="relative h-64 overflow-hidden rounded-t-3xl">
                      ...
                      >
                        ...
                        <div className="absolute inset-0 opacity-10">
                          <AnimatedBackground
                            type={opportunity.animationType}
                          />
                        </div>
                      </motion.div>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div
                            className={`w-3 h-3 bg-gradient-to-r ${opportunity.color} rounded-full animate-pulse`}
                          ></div>
      ...
      {/* Technical Skills Section with Freepik Illustrations */}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Master cutting-edge technologies and build expertise in the most
                in-demand tech skills of 2025.
              </p>
            </motion.div>{" "}
              ...
              {[
                {
                  ...
                  description:
                    "React, Vue.js, Angular, TypeScript, Next.js and modern web technologies",
                ...
                },
                {
                  ...
                  description:
                    "Node.js, Python, Java, microservices and scalable server architectures",
                ...
                },
                {
                  ...
                  description:
                    "React Native, Flutter, iOS and Android native development",
                ...
                },
                {
                  ...
                  description:
                    "TensorFlow, PyTorch, computer vision, NLP and deep learning",
                ...
                },
                {
                  title: "Data Science",
                  description:
                    "Analytics, visualization, big data processing and statistical modeling",
                ...
                },
                {
                  title: "UI/UX Design",
                  description:
                    "Figma, Adobe Creative Suite, user research and design systems",
                ...
                >
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-white/50">
                    ...
                    <div
                      className={`relative h-48 overflow-hidden bg-gradient-to-br ${skill.bgColor} rounded-t-3xl`}
                    >
                      <motion.div
                        className="relative w-full h-full"
                        whileHover={{ scale: 1.03 }}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-2">
                Fill out our streamlined application form and take the first
                step towards joining our incredible team. We're excited to learn
                about your unique skills and aspirations!
              </p>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-white/50 to-indigo-100/30 rounded-3xl blur-xl transform -rotate-1"></div>{" "}
              <div className="relative bg-white/90 backdrop-blur-md rounded-3xl p-10 shadow-[0_20px_50px_rgba(79,70,229,0.2)] border-2 border-white/70 hover:shadow-[0_25px_60px_rgba(79,70,229,0.3)] transition-all duration-500">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto">
                We're not just another company – we're a community of
                innovators, dreamers, and achievers who believe in making a
              ...
              {[
                {
                  ...
                  title: "Learn & Grow",
                  description:
                    "Access cutting-edge technologies, world-class mentorship, and unlimited learning opportunities to accelerate your career.",
                  color: "from-blue-500 to-cyan-500",
                ...
                },
                {
                  ...
                  title: "Amazing Team",
                  description:
                    "Collaborate with passionate individuals from diverse backgrounds who share your drive for innovation and excellence.",
                  color: "from-purple-500 to-pink-500",
                ...
                },
                {
                  ...
                  title: "Real Impact",
                  description:
                    "Work on meaningful projects that solve real-world problems and build an impressive professional portfolio.",
                  color: "from-green-500 to-emerald-500",
                ...
                },
                {
                  ...
                  title: "Recognition",
                  description:
                    "Get acknowledged for your contributions with certificates, public recognition, and career advancement opportunities.",
                  color: "from-orange-500 to-red-500",
                ...
                },
                {
                  ...
                  title: "Career Growth",
                  description:
                    "Clear pathways for advancement with opportunities to lead teams, mentor others, and shape the future of our company.",
                  color: "from-teal-500 to-blue-500",
                ...
                },
                {
                  ...
                  description:
                    "Flexible schedules that respect your personal time, academic commitments, and individual lifestyle needs.",
                  color: "from-pink-500 to-purple-500",
                ...
                >
                  ...
                  <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 hover:border-white/40 transition-all duration-500 group-hover:bg-white/15">
                    {/* Icon */}
                    <div
                      className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r ${benefit.color} rounded-2xl mb-6 group-hover:scale-110 transition-all duration-300 shadow-xl`}
                    >
                    ...
                    {/* Decorative Element */}
                    <div
                      className={`absolute top-4 right-4 w-6 h-6 bg-gradient-to-r ${benefit.color} rounded-full opacity-50 group-hover:opacity-100 transition-opacity duration-300`}
                    ></div>
                  </div>
                </motion.div>
              ))}
            ...
            >
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-lg text-gray-300 mb-8">
                  Join thousands of talented individuals who have already
                  started their journey with us. Your dream career is just one
                  click away.
                </p>
                <motion.button
                  whileHover={{ scale: 1.05 }}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                ...
                members about their experience working with us.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  testimonial:
                    "Working at Internexis has been transformative. The learning opportunities are endless and the team is incredibly supportive.",
                  rating: 5,
                },
                {
                  name: "Michael Chen",
                  ...
                  testimonial:
                    "The creative freedom and collaborative environment here has helped me grow both professionally and personally.",
                  rating: 5,
                },
                {
                  ...
                  testimonial:
                    "Internexis values work-life balance and provides amazing opportunities for career advancement. Best decision I ever made!",
                  rating: 5,
                },
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                From comprehensive training to ongoing support, we provide
                everything you need to succeed in your career journey with us.
              </p>
            </motion.div>{" "}
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  ...
                  description:
                    "Comprehensive coding bootcamps and skill development programs",
                ...
                },
                {
                  ...
                  description:
                    "One-on-one guidance from industry experts and senior professionals",
                ...
                },
                {
                  ...
                  description:
                    "Access to cutting-edge tools and experimental project opportunities",
                ...
                },
                {
                  title: "Modern Office",
                  description:
                    "State-of-the-art facilities and collaborative workspaces",
                ...
                >
                  <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-white/50">
                    ...
                    <div
                      className={`relative h-48 overflow-hidden bg-gradient-to-br ${service.bgColor} rounded-t-3xl`}
                    >
                      <motion.div
                        className="relative w-full h-full"
        ...
        <div className="container mx-auto px-8">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                See how our team members have grown their careers and achieved
                their goals with Internexis.{" "}
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="relative">
                  {" "}
                  <div className="w-full h-[500px] rounded-3xl bg-gradient-to-br from-yellow-50 to-orange-50 flex items-center justify-center shadow-[0_20px_50px_rgba(234,88,12,0.2)] hover:shadow-[0_25px_60px_rgba(234,88,12,0.3)] overflow-hidden relative p-8 transition-all duration-500">
                ...
                {[
                  {
                    ...
                    description:
                      "Of our team members receive promotions within their first year",
                  },
                  {
                    number: "4.9/5",
                    label: "Satisfaction Rating",
                    description:
                      "Average rating from our team members across all departments",
                  },
                  {
                    number: "500+",
                    label: "Skills Learned",
                    description:
                      "Different technical and soft skills acquired by our team",
                  },
                  {
                    number: "50+",
                    label: "Success Stories",
                    description:
                      "Amazing career transformations and achievements documented",
                  },
                ].map((stat, index) => (
                  <motion.div
                    key={index}
