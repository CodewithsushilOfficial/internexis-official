        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore diverse opportunities across different domains and find
              the role that matches your passion and skills.
            </p>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                {" "}
                <div
                  className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r ${opportunities[activeTab].color} rounded-2xl mb-8 shadow-lg`}
                >
                  {React.createElement(opportunities[activeTab].icon, {
                  ...
                  {opportunities[activeTab].benefits.map((benefit, index) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-12 h-12 bg-gradient-to-r ${opportunities[activeTab].color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                        >
                ...
                <div className="mt-8 grid grid-cols-2 gap-4">
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center shadow-lg border border-white/50">
                    <div className="text-2xl font-bold text-gray-900 mb-1">
                      {
                        getRoleStats(opportunities[activeTab].title)
                          .activeMembers
                      }
                    </div>
          ...
          >
            {opportunities.map((opportunity, index) => (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r ${opportunity.color} rounded-xl mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
