    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            Internexis provides verified, downloadable, and industry-recognized
            certificates
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="lg:w-1/2 w-full">
            ...
            >
              ...
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-tr ${
                  isDarkMode
          ...
          <div className="lg:w-1/2 w-full">
            ...
            >
              {Object.keys(tabContent).map((tab) => (
                <button
                  ...
                  onClick={() =>
                    setActiveTab(
                      tab as "internship" | "training" | "evaluation",
                    )
                  }
                >
            ...
            >
              ...
              <div
                ...
                } rounded-bl-[100px] rounded-tr-2xl z-0`}
              ></div>
              ...
              <ul className="space-y-3 mb-8 relative z-10">
                {tabContent[activeTab].features.map((feature, index) => (
                  <li key={index} className="flex items-start">
                    <span
                      className={`flex items-center justify-center w-7 h-7 rounded-full mr-3 mt-0.5 flex-shrink-0 ${
                        isDarkMode
                    ...
                    >
                      ...
                      <span
                        className={`absolute inset-0 rounded-full bg-current opacity-0 group-hover:opacity-25 group-hover:animate-ping`}
                      ></span>
                      <svg
              ...
              >
                <div className="flex items-start">
                  <div
                    className={`mr-4 p-2.5 rounded-lg ${
                      isDarkMode
                        ? `bg-${tabColors[activeTab].dark}/30`
                        : `bg-${tabColors[activeTab].light}/20`
                    }`}
                  >
                    <svg
                  ...
                  <div>
                    <h5
                      className={`font-bold text-lg mb-1 ${tabColors[activeTab].highlight}`}
                    >
                      Verification System
                    </h5>
                    <p
                      className={`${isDarkMode ? "text-gray-300" : tabColors[activeTab].text}`}
                    >
                      Each certificate includes a unique QR code and
                      verification ID that employers can use to validate
                      authenticity through our online portal.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <button
                className={`mt-8 px-8 py-3.5 rounded-lg font-medium transition-all duration-300 
                bg-gradient-to-r ${
                  isDarkMode
                    ? tabColors[activeTab].dark
                    : tabColors[activeTab].light
