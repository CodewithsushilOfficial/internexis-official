          ...
          <div className="text-center mb-16">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Join <span className="font-bold text-blue-600">10,000+</span> successful students who transformed their potential into 
                <span className="font-semibold"> professional excellence</span> through our industry-leading internship programs.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-8 mt-8">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-indigo-600">₹8.5L</div>
                  ...
                  <div key={idx} className="flex items-center w-full lg:w-auto">
                    <div className="flex flex-col items-center relative">
                      ...
                      <div className="text-center mt-4">
                        <div className={`font-semibold ${idx <= currentStep ? 'text-blue-600' : 'text-gray-500'}`}>
                          {step.title}
                        </div>
                    ...
                    {idx < steps.length - 1 && (
                      <div className="hidden lg:block flex-1 mx-6">
                        <div className={`h-1 rounded-full transition-all duration-300 ${
                          idx < currentStep ? 'bg-gradient-to-r from-blue-600 to-purple-600' : 'bg-gray-200'
                        }`}></div>
                      </div>
                    )}
                  </div>
              ...
              <div className="relative p-12 text-center">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                    ...
                    application and contact you within <span className="font-bold text-green-600">24-48 hours</span>.
                  </p>
                  ...
                  <div className="relative inline-flex items-center gap-4 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-3xl px-8 py-6 mb-6 border border-blue-100/50 backdrop-blur-sm shadow-lg">
                    <div className="relative">
                      <div className="w-12 h-12 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg">
                        <span className="text-white font-black text-lg">{currentStep + 1}</span>
                      </div>
                    </div>
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-gray-600 font-medium">{steps[currentStep].subtitle}</div>
                      ...
                      <div className="mt-3 flex items-center gap-2">
                        ...
                        <div className="text-xs text-gray-600 font-bold">{Math.round(((currentStep + 1) / steps.length) * 100)}%</div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input
                            ...
                            className={`w-full border-2 rounded-2xl px-6 py-4 text-gray-900 placeholder-gray-500 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-4 focus:ring-blue-200/50 focus:border-blue-500 transition-all duration-300 hover:border-blue-300 hover:shadow-lg font-medium ${
                              errors.fullName ? "border-red-500 bg-red-50/80" : "border-gray-200"
                            }`}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full border-2 rounded-2xl px-6 py-4 text-gray-900 placeholder-gray-500 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-4 focus:ring-green-200/50 focus:border-green-500 transition-all duration-300 hover:border-green-300 hover:shadow-lg font-medium ${
                              errors.email ? "border-red-500 bg-red-50/80" : "border-gray-200"
                            }`}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full border-2 rounded-2xl px-6 py-4 text-gray-900 placeholder-gray-500 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-4 focus:ring-purple-200/50 focus:border-purple-500 transition-all duration-300 hover:border-purple-300 hover:shadow-lg font-medium ${
                              errors.mobileNumber ? "border-red-500 bg-red-50/80" : "border-gray-200"
                            }`}
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          >
                            ...
                            <p className="text-2xl font-bold text-orange-600 mt-2">₹999</p>
                          </div>
                          <div
                          ...
                          >
                            ...
                            <p className="text-2xl font-bold text-orange-600 mt-2">₹1499</p>
                          </div>
                        </div>
                      ...
                      <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-3xl p-8 border-2 border-green-200/50 text-center">
                        ...
                        <div className="bg-white rounded-2xl p-6 border border-green-200 mb-6">
                          ...
                          <ol className="text-left text-sm text-gray-600 space-y-1">
                            ...
                            <li>2. Pay the amount: <span className="font-bold text-green-600">
                              {formData.internshipDuration === '1 Month' ? '₹999' : 
                               formData.internshipDuration === '2 Months' ? '₹1499' : '₹999'}
                            </span></li>
            ...
            <div className="mt-16">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  Why Choose Our <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Internship Program?</span>
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/30 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <h3 className="font-bold text-gray-900 mb-2">Lightning Fast Process</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Complete application review within 24 hours with priority interview scheduling and instant feedback.</p>
                </div>
                ...
                <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/30 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <h3 className="font-bold text-gray-900 mb-2">Industry Projects</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Work on real-world projects with Fortune 500 companies and build a portfolio that stands out.</p>
                </div>
                ...
                <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/30 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">1-on-1 guidance from industry veterans with proven track records in top tech companies.</p>
                </div>
                ...
                <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/30 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <h3 className="font-bold text-gray-900 mb-2">Placement Guarantee</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">100% placement assistance with our extensive network of hiring partners across India.</p>
                </div>
              </div>
            </div>
          )}
