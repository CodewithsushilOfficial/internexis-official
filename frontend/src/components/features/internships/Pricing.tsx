...
export const Pricing: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 transition-colors duration-300" id="pricing">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          ...
          {pricingTiers.map((tier) => (
            ...
            >
              ...
              <div className={`p-8 ${tier.recommended ? 'pt-12' : 'pt-8'}`}>
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">{tier.duration}</h3>
                ...
                <div className="flex items-baseline mb-6">
                  ...
                  <span className="ml-1 text-gray-600 dark:text-gray-400">one-time</span>
                </div>
                ...
                <div className="space-y-4 mb-8">
                  {tier.features.map((feature, index) => (
                    <div key={index} className="flex items-center">
                      ...
                      <span className={feature.included ? 'text-gray-800 dark:text-gray-200' : 'text-gray-400 dark:text-gray-500'}>
                        {feature.text}
                      </span>
                    </div>
                  ))}
        ...
        >
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Need a Custom Package?</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            We offer tailored solutions for universities, colleges, and student groups.
            Contact us for special group rates and custom program durations.
          </p>
          <motion.a 
            href="#contact" 
