...
const DomainDetails: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "syllabus" | "projects" | "career"
  >("overview");
  ...
  const domainData: Record<string, DomainInfo> = useMemo(
    () => ({
      web: {
        ...
        description:
          "Master frontend, backend, or full-stack development using industry-standard technologies and frameworks.",
        ...
        projects: [
          {
            ...
            description:
              "Build a complete online shopping platform with user authentication, product catalog, and payment integration",
            difficulty: "Advanced",
            duration: "4 Weeks",
          ...
          },
          {
            ...
            description:
              "Create a collaborative project management tool with real-time updates",
      ...
      android: {
        ...
        description:
          "Build powerful Android apps using modern development tools and frameworks with real-world implementations.",
        ...
        syllabus: [
          {
            ...
            learningOutcome:
              "Understand Android app structure and basic components",
          },
          {
            id: 2,
            title: "UI/UX Design",
        ...
        projects: [
          {
            ...
            description:
              "Build a complete social networking application with real-time features",
            difficulty: "Advanced",
            duration: "4 Weeks",
      ...
      ai: {
        ...
        description:
          "Explore artificial intelligence and machine learning with hands-on projects and real-world applications.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <section
        className={`relative bg-gradient-to-r ${domainInfo.gradient} text-white py-8 sm:py-12 md:py-16 lg:py-20 overflow-hidden`}
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-4 sm:mb-6 md:mb-8">
            ...
            >
              <ArrowLeft
                size={16}
                className="mr-2 group-hover:-translate-x-1 transition-transform sm:w-5 sm:h-5"
              />
            ...
            <div className="flex-1 space-y-4 sm:space-y-6 md:space-y-8 text-center lg:text-left w-full">
              ...
              >
                ...
                >
                  <Sparkles
                    size={8}
                    className="text-yellow-800 sm:w-3 sm:h-3 md:w-3.5 md:h-3.5"
                  />
                </motion.div>
              </motion.div>
              ...
              >
                <div className="bg-white/20 backdrop-blur-sm rounded-lg sm:rounded-xl px-3 py-2 sm:px-4 sm:py-3 md:px-6 md:py-4 border border-white/10">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <Clock
                      size={14}
                      className="text-white/80 sm:w-4 sm:h-4 md:w-5 md:h-5"
                    />
                    <div>
              ...
              >
                ...
                >
                  <Rocket
                    size={16}
                    className="group-hover:rotate-12 transition-transform sm:w-5 sm:h-5"
                  />
                  Apply Now
                </Link>
                <button
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="sm:hidden py-3">
            <div className="relative">
              ...
              >
                <option value="overview" className="bg-white text-gray-800">
                  🔍 Overview
                </option>
                <option value="syllabus" className="bg-white text-gray-800">
                  📚 Syllabus
                </option>
                <option value="projects" className="bg-white text-gray-800">
                  🛠️ Projects
                </option>
                <option value="career" className="bg-white text-gray-800">
                  💼 Career
                </option>
              </select>
          ...
          <div className="hidden sm:flex space-x-1 overflow-x-auto scrollbar-hide">
            {[
              ...
              },
              {
                ...
                description: "Detailed curriculum",
              },
              {
                id: "projects",
                label: "Projects",
              ...
              <motion.button
                ...
                onClick={() =>
                  setActiveTab(
                    tab.id as "overview" | "syllabus" | "projects" | "career",
                  )
                }
              ...
              >
                ...
                <div
                  className={`relative p-1.5 sm:p-2 rounded-lg sm:rounded-xl transition-all duration-300 ${
                    activeTab === tab.id
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-400 group-hover:text-gray-500 hidden md:block">
                    {tab.description}
                  </div>
                </div>
              </motion.button>
            ...
            >
              ...
              <div>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6 md:mb-8">
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-r ${domainInfo.gradient} rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0`}
                  >
                    <Zap
                      size={16}
                  ...
                  {domainInfo.techStack.map((tech, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2 sm:mb-3 md:mb-4">
                        ...
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${getDifficultyColor(tech.level)}`}
                        >
                          {tech.level}
                        </span>
                      </div>
                    ...
                    {domainInfo.syllabus.map((module, index) => (
                      ...
                      >
                        ...
                        <div className="hidden sm:flex absolute left-0 top-4 sm:top-6 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-white rounded-full border-4 border-gray-200 items-center justify-center z-10 shadow-lg">
                          <span
                            className={`font-bold text-sm sm:text-base md:text-lg text-${domainInfo.color}-600`}
                          >
                            {index + 1}
                          </span>
                        </div>
              ...
              {domainInfo.syllabus.map((module, index) => (
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <div
                      className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-${domainInfo.color}-500 text-white flex items-center justify-center font-bold text-sm sm:text-base md:text-lg`}
                    >
                      {index + 1}
                    </div>
                      ...
                      <ul className="space-y-1 sm:space-y-2">
                        {module.topics.map((topic, idx) => (
                          <li key={idx} className="flex items-center gap-2">
                            <CheckCircle
                              size={14}
                              className={`text-${domainInfo.color}-500 sm:w-4 sm:h-4`}
                            />
                            <span className="text-xs sm:text-sm md:text-base">
                              {topic}
                            </span>
