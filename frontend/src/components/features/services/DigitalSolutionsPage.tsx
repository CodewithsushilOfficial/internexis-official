        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              Website development, app development, AI automations, generative
              AI, and innovative digital solutions for businesses and
              professionals. Transform your ideas into powerful digital
              solutions with our expert development team.
            </p>
