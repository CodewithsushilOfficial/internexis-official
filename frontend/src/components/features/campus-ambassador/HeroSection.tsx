...
const HeroSection: React.FC = () => {
  return (    <div className="relative min-h-[100vh] flex items-center overflow-hidden">
      {/* Gradient Background */}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[30%] right-[15%] w-16 h-16 opacity-25">
          <div className="w-full h-full bg-gradient-to-br from-pink-400 to-red-500 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
        </div>
        <div className="absolute bottom-[20%] left-[20%] w-20 h-20 opacity-20">
          <div className="w-full h-full bg-gradient-to-br from-green-400 to-emerald-500 transform rotate-45 animate-float" style={{animationDelay: '2s'}}></div>
        </div>
        <div className="absolute top-[60%] right-[25%] w-14 h-14 opacity-30">
          <div className="w-full h-full bg-gradient-to-br from-yellow-400 to-orange-500 rounded-lg transform -rotate-12 animate-float" style={{animationDelay: '0.5s'}}></div>
        </div>
        
        {/* Particle Effects */}
        <div className="absolute top-[25%] left-[60%] w-2 h-2 bg-white rounded-full opacity-60 animate-pulse"></div>
        <div className="absolute top-[45%] left-[15%] w-1 h-1 bg-blue-300 rounded-full opacity-80 animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-[75%] right-[40%] w-1.5 h-1.5 bg-purple-300 rounded-full opacity-70 animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>

      {/* Mesh Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-purple-500/10 to-transparent animate-pulse opacity-50"></div>      <div className="container mx-auto px-6 relative z-20">
          ...
          <div className="lg:w-1/2 text-center lg:text-left text-white">
            ...
            <div className="inline-flex items-center px-6 py-3 bg-white/20 backdrop-blur-lg rounded-full mb-8 border border-white/30 shadow-2xl">
              <div className="flex items-center">
                ...
                <span className="text-sm font-semibold text-white">🎓 Applications Open 2025-26</span>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-8 leading-tight">
              ...
              <span className="block bg-gradient-to-r from-pink-400 via-red-400 to-yellow-400 bg-clip-text text-transparent animate-gradient-x" style={{animationDelay: '0.5s'}}>
                Ambassador
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-10 leading-relaxed max-w-2xl font-light">
              🚀 Lead the <span className="font-semibold text-cyan-300">tech revolution</span> at your university. 
              Build your <span className="font-semibold text-pink-300">professional network</span>, 
              gain real-world experience, and earn <span className="font-semibold text-yellow-300">exciting rewards</span> 
            ...
            <div className="grid grid-cols-3 gap-8 text-center">
              <div className="group cursor-pointer">
                <div className="text-3xl font-black text-cyan-400 mb-2 group-hover:scale-110 transition-transform duration-300">500+</div>
                <div className="text-gray-300 text-sm font-medium">Universities</div>
              </div>
              <div className="group cursor-pointer">
                <div className="text-3xl font-black text-pink-400 mb-2 group-hover:scale-110 transition-transform duration-300">₹1L+</div>
                <div className="text-gray-300 text-sm font-medium">Rewards Earned</div>
              </div>
              <div className="group cursor-pointer">
                <div className="text-3xl font-black text-yellow-400 mb-2 group-hover:scale-110 transition-transform duration-300">2K+</div>
                <div className="text-gray-300 text-sm font-medium">Ambassadors</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="relative bg-white/10 backdrop-blur-2xl rounded-2xl p-6 border border-white/20 shadow-2xl transform hover:scale-105 transition-all duration-500">
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-white mb-1">Program Highlights</h3>
                <p className="text-gray-300 text-xs">Join India's fastest growing ambassador program</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="group text-center p-4 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-xl border border-white/10 hover:scale-105 transition-all duration-300">
                  <div className="text-2xl font-black text-cyan-400 mb-1">500+</div>
                  <div className="text-gray-300 text-xs font-medium">Top Universities</div>
                </div>
                <div className="group text-center p-4 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl border border-white/10 hover:scale-105 transition-all duration-300">
                  <div className="text-2xl font-black text-purple-400 mb-1">₹1L+</div>
                  <div className="text-gray-300 text-xs font-medium">Max Rewards</div>
                </div>
                <div className="group text-center p-4 bg-gradient-to-br from-pink-500/20 to-red-500/20 rounded-xl border border-white/10 hover:scale-105 transition-all duration-300">
                  ...
                  <div className="text-gray-300 text-xs font-medium">Active Members</div>
                </div>
                <div className="group text-center p-4 bg-gradient-to-br from-yellow-500/20 to-orange-500/20 rounded-xl border border-white/10 hover:scale-105 transition-all duration-300">
                  ...
                  <div className="text-gray-300 text-xs font-medium">Live Support</div>
                </div>
              </div>              {/* Compact Benefits Preview */}
              <div className="space-y-3">
                <div className="flex items-center group cursor-pointer">
                  ...
                  <div>
                    <div className="text-white font-medium text-sm">💰 Earn Up to ₹1L+ Rewards</div>
                    <div className="text-gray-400 text-xs">Cash + goodies + certificates</div>
                  </div>
                </div>
                ...
                <div className="flex items-center group cursor-pointer">
                  ...
                  <div>
                    <div className="text-white font-medium text-sm">🎯 Build Professional Network</div>
                    <div className="text-gray-400 text-xs">Connect with industry leaders</div>
                  </div>
                </div>
                ...
                <div className="flex items-center group cursor-pointer">
                  ...
                  <div>
                    <div className="text-white font-medium text-sm">🏆 Get Official Recognition</div>
                    <div className="text-gray-400 text-xs">Certificates + LinkedIn badges</div>
                  </div>
                </div>
              </div>
