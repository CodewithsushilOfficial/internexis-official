...
import { PlusIcon, PencilIcon, TrashIcon, EyeIcon, CalendarIcon, CurrencyDollarIcon } from '@heroicons/react/24/outline';
...
const FreelanceProjectsManager: React.FC = () => {
  ...
  const openEditModal = (project: FreelanceProject) => {
    ...
    setFormData({
      ...
      projectImages: project.projectImages.length > 0 ? project.projectImages : [''],
  ...
  const addArrayField = (field: 'technologies' | 'projectImages' | 'challenges' | 'solutions' | 'keyFeatures') => {
    setFormData(prev => ({
      ...prev,
      [field]: [...prev[field], '']
    }));
  ...
  const updateArrayField = (field: 'technologies' | 'projectImages' | 'challenges' | 'solutions' | 'keyFeatures', index: number, value: string) => {
    setFormData(prev => ({
      ...prev,
  ...
  const removeArrayField = (field: 'technologies' | 'projectImages' | 'challenges' | 'solutions' | 'keyFeatures', index: number) => {
    setFormData(prev => ({
      ...prev,
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage and showcase your project portfolio</p>
        </div>
        <motion.button
        ...
        {filteredProjects.map((project) => (
          ...
          >
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm mb-4 line-clamp-3">{project.description}</p>              <div className="space-y-2 text-sm text-gray-500">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>{project.budget.currency} {project.budget.amount.toLocaleString()}</span>
                </div>
              ...
              </div>              {(project.liveLink || project.githubLink || project.portfolioLink) && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ 
                        ...prev, 
                        client: { ...prev.client, rating: parseInt(e.target.value) }
                      }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setFormData(prev => ({ 
                        ...prev, 
                        client: { ...prev.client, testimonial: e.target.value }
                      }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
                    ...
                    {formData.projectImages.map((image, index) => (
                      <div key={index} className="flex gap-2 mb-2">
                        <input
                          type="url"
                          value={image}
                          onChange={(e) => updateArrayField('projectImages', index, e.target.value)}
                        ...
                        {formData.projectImages.length > 1 && (
                          <button
                            type="button"
                            onClick={() => removeArrayField('projectImages', index)}
                            className="text-red-600 hover:text-red-800"
                          >
                            <TrashIcon className="h-5 w-5" />
                          </button>
                  ...
                  </div>                  <div className="md:col-span-2 flex gap-4">
                    <label className="flex items-center">
                      <input
                        type="checkbox"
                        checked={formData.isShowcase}
                        onChange={(e) => setFormData(prev => ({ ...prev, isShowcase: e.target.checked }))}
                        className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                      />
                      <span className="ml-2 text-sm text-gray-700">Showcase Project</span>
                    </label>
