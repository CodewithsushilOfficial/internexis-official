...
const DigitalSolutionsManager: React.FC = () => {
  ...
  const fetchSolutions = async () => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/api/digital-solutions/admin/all`,
      );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingItem) {
        await axios.put(
          `${API_URL}/api/digital-solutions/admin/${editingItem._id}`,
          cleanedData,
        );
      } else {
  ...
  const filteredSolutions = solutions.filter((solution) => {
    ...
    const matchesCategory =
      !filterCategory || solution.category === filterCategory;
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-gray-600">
              Manage your digital services and solutions
            </p>
          </div>
          <button
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                <div className="text-sm text-gray-600 mb-1">
                  <strong>Price:</strong> ₹{solution.price.startingPrice}+{" "}
                  ...
                  {formData.features.map((feature, index) => (
                    <div key={index} className="flex mb-2">
                      <input
                        ...
                        value={feature}
                        onChange={(e) =>
                          updateArrayField("features", index, e.target.value)
                        }
          ...
          >
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Are you sure you want to delete this digital solution? This
