...
const firstNames = [
  ...
  'Aadhya', 'Saanvi', 'Aanya', 'Diya', 'Ananya', 'Isha', 'Kavya', 'Priya', 'Riya', 'Sneha'
];

const lastNames = [
  'Sharma', 'Verma', 'Gupta', 'Singh', 'Kumar', 'Agarwal', 'Jain', 'Patel', 'Shah', 'Mehta',
  'Malhotra', 'Sinha', 'Tiwari', 'Mishra', 'Joshi', 'Nair', 'Rao', 'Reddy', 'Iyer', 'Bansal'
];

const universities = [
  'Delhi University', 'Mumbai University', 'Pune University', 'Bangalore University', 'Chennai University',
  'IIT Delhi', 'IIT Bombay', 'IIT Kanpur', 'NIT Trichy', 'BITS Pilani',
  'VIT Vellore', 'SRM University', 'Manipal University', 'Christ University', 'NMIMS Mumbai',
  'Amity University', 'Lovely Professional University', 'Chandigarh University', 'Sharda University', 'Bennett University'
];

const courses = [
  'Computer Science Engineering', 'Information Technology', 'Electronics Engineering', 'Mechanical Engineering',
  'Civil Engineering', 'Business Administration', 'Commerce', 'Economics', 'Psychology', 'Mass Communication',
  'Biotechnology', 'Chemical Engineering', 'Electrical Engineering', 'Aerospace Engineering', 'Data Science',
  'Artificial Intelligence', 'Cybersecurity', 'Digital Marketing', 'Graphic Design', 'Fashion Design'
];

const yearOfStudy = ['1st Year', '2nd Year', '3rd Year', '4th Year', 'Final Year'];

const skills = [
  'Leadership', 'Communication', 'Marketing', 'Social Media Management', 'Event Planning',
  'Public Speaking', 'Team Management', 'Content Creation', 'Photography', 'Video Editing',
  'Graphic Design', 'Web Development', 'Project Management', 'Sales', 'Customer Relations',
  'Creative Writing', 'Digital Marketing', 'Brand Management', 'Network Building', 'Problem Solving'
];

const availabilityHours = ['5-10 hours', '10-15 hours', '15-20 hours', '20+ hours'];

const referralSources = [
  'Social Media', 'Friend Referral', 'University Notice', 'Website', 'Email Campaign',
  'Campus Event', 'Career Fair', 'LinkedIn', 'Instagram', 'WhatsApp Group',
  'Professor Recommendation', 'Alumni Network', 'Job Portal', 'Online Advertisement', 'College Magazine'
];
...
export function generateSampleCampusAmbassadorData(): CampusAmbassadorFormData {
  ...
  const selectedSkills = getRandomElements(skills, Math.floor(Math.random() * 3) + 3); // 3-5 skills
  ...
  return {
    ...
    portfolioUrl: Math.random() > 0.5 ? `https://portfolio-${firstName.toLowerCase()}.vercel.app` : '',
    ...
    additionalInfo: Math.random() > 0.7 ? 'I am highly motivated and committed to excellence in everything I do.' : ''
  };
}

export function generateMultipleSampleData(count: number): CampusAmbassadorFormData[] {
